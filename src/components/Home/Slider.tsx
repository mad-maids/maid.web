...
const InfoEntry: FunctionComponent<InfoEntryProps> = ({
  itemText,
  itemSubtitle,
}) => (
  <p>
...
const HomepageSlider: FunctionComponent<HomepageSliderProps> = ({
  data,
  onCursor,
}) => {
          ...
          <SliderNavigation>
            ...
            <SliderArrows>
              <button
                type="button"
                onClick={(): void =>
                  prevSlide(imageList, numList, imageWidth, setActive, infoList)
                }
              ...
              <button
                type="button"
                onClick={(): void =>
                  nextSlide(imageList, numList, imageWidth, setActive, infoList)
                }
                style={{ background: "none" }}
                onMouseEnter={(): void => {
                  hoverIn();
