...
const CodeBlock: FunctionComponent<CodeProps> = (props) => {
	...
	const highlightedLines = props.highlightedLines ? rangeParser.parse(props.highlightedLines) : [];
	...
	const lines = reversedLines.filter((line, index) => index >= firstNonEmptyIndex).reverse();
	return (
		<SyntaxHighlighter
			style={theme}
			language={language}
