...
const WorkImage: FunctionComponent<WorkImageProps> = ({ imgName, text, isCaption }) => {
	...
	}, [imgHolder, over, imgRef, t1, inView, captionHolder, animation, isCaption]);
	...
	return (
		<div ref={ref}>
			...
			<ImageHolder animate={animation} initial="hidden" variants={imgholder} ref={(el): void => (imgHolder = el)}>
				<ImageOver animate={animation} variants={overlay} ref={(el): void => (over = el)} />
