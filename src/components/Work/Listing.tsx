...
const WorkListing: FunctionComponent<WorkListingProps> = ({
  data,
  page = 1,
  onCursor,
}) => {
  ...
  const { previous, next, fromResult, toResult } =
  ...
  return (
    <>
      <Con>
        <LabSub>
          Personally, I want this website to be a respresentation of creativity
          and experimentation. No rules, no parameters, nothing but full
          freedom. The design world shows no mercy, so upgrading my skills is a
          priority.
        </LabSub>
      </Con>
      <WorkFeed>
